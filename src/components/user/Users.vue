<template>
    <div>
                ...
                <el-table-column  label="状态" align="center">
                    <template slot-scope="slotProps">
                        <el-switch
                            ...
                            active-color="#13ce66"
                            inactive-color="#ff4949" @change="stateChange(slotProps.row)">
                        </el-switch>
                    </template>
                </el-table-column>
        ...
        <el-dialog
            ...
            <el-form :model="addUsersForm" :rules="addUsersFormRules" ref="addUsersFormRef" label-width="100px" class="demo-ruleForm">
        ...
        <el-dialog
            ...
            <el-form :model="editUsersForm" :rules="addUsersFormRules" ref="editUsersFormRef" label-width="100px" class="demo-ruleForm">
                <el-form-item label="用户名:" prop="username" >
    ...
    methods:{
        ...
        editUserInfo:function(){
            ...
            var res = this.$refs.editUsersFormRef.validate(async function(bool, obj) {
                ...
                const { data: ret } = await that.$http.put('/users/'+that.editUsersForm.id, {email:that.editUsersForm.email,mobile:that.editUsersForm.mobile})
        ...
        async saveRoleInfo(){
            ...
            const {data:ret}=await this.$http.put(`/users/${this.roleList.id}/role`,{rid:this.selectedRoleId})
